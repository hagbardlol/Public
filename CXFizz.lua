...
module("Coozbie Fizz", package.seeall, log.setup)
clean.module("Coozbie Fizz", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/CXFizz.lua", "1.7")
