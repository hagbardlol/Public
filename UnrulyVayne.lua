...
module("UnrulyVayne", package.seeall, log.setup)
clean.module("UnrulyVayne", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/UnrulyVayne.lua", "1.0.5")
