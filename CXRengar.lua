...
module("Coozbie Rengar", package.seeall, log.setup)
clean.module("Coozbie Rengar", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/CXRengar.lua", "1.0.3")
