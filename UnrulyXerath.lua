...
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/UnrulyXerath.lua", "1.0.5")
...
function Xerath.LoadMenu()
    Menu.RegisterMenu("UnrulyXerath", "Unruly Xerath", function()
        Menu.ColumnLayout("cols", "cols", 2, true, function()
            ...
            Menu.Slider("Combo.ChanceQ", "HitChance [Q]", 0.50, 0, 1, 0.1)
            Menu.Checkbox("Combo.UseW", "Use [W]", true)
            Menu.Slider("Combo.ChanceW", "HitChance [W]", 0.50, 0, 1, 0.1)
            Menu.Checkbox("Combo.UseE", "Use [E]", true)
            Menu.Slider("Combo.ChanceE", "HitChance [E]", 0.60, 0, 1, 0.1)
            Menu.Checkbox("Combo.UseR", "Use [R]", true)
            Menu.Slider("Combo.ChanceR", "HitChance [R]", 0.40, 0, 1, 0.1)
            ...
            Menu.Slider("Harass.ChanceQ", "HitChance [Q]", 0.60, 0, 1, 0.1)
            Menu.Checkbox("Harass.UseW", "Use [W]", true)
            Menu.Slider("Harass.ChanceW", "HitChance [W]", 0.60, 0, 1, 0.1)
            Menu.Checkbox("Harass.UseE", "Use [E]", true)
            Menu.Slider("Harass.ChanceE", "HitChance [E]", 0.70, 0, 1, 0.1)
        end) 
