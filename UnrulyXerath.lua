...
module("UnrulyXerath", package.seeall, log.setup)
clean.module("UnrulyXerath", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/UnrulyXerath.lua", "1.0.7")
