if Player.CharName ~= "Nilah" then return end

module("Coozbie Nilah", package.seeall, log.setup)
clean.module("Coozbie Nilah", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/CXNilah.lua", "1.6")
