if Player.CharName ~= "Kayn" then return end

module("Coozbie Kayn", package.seeall, log.setup)
clean.module("Coozbie Kayn", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/CXKayn.lua", "1.5")
