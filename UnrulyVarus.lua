...
module("UnrulyVarus", package.seeall, log.setup)
clean.module("UnrulyVarus", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/UnrulyVarus.lua", "1.0.6")
