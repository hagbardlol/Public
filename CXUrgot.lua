...
module("Coozbie Urgot", package.seeall, log.setup)
clean.module("Coozbie Urgot", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/CXUrgot.lua", "1.4")
