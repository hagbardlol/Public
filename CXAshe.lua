...
module("Coozbie Ashe", package.seeall, log.setup)
clean.module("Coozbie Ashe", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/CXAshe.lua", "1.7")
