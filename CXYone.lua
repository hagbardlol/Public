if Player.CharName ~= "Yone" then return end

module("Coozbie Yone", package.seeall, log.setup)
clean.module("Coozbie Yone", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/CXYone.lua", "1.6")
