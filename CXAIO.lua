...
module("CXAIO", package.seeall, log.setup)
clean.module("CXAIO", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/CXAIO.lua", "1.0.10")
