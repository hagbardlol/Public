...
module("Coozbie Kassadin", package.seeall, log.setup)
clean.module("Coozbie Kassadin", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/CXKassadin.lua", "1.4")
