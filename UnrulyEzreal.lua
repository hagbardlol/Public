...
module("UnrulyEzreal", package.seeall, log.setup)
clean.module("UnrulyEzreal", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/UnrulyEzreal.lua", "1.0.4")
