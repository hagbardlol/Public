...
module("Coozbie TahmKench", package.seeall, log.setup)
clean.module("Coozbie TahmKench", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/CXTahmKench.lua", "1.3")
