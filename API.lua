...
---@class ItemIDs
---@field AbyssalMask number
---@field AegisOfTheLegion number
---@field AetherWisp number
---@field AmplifyingTome number
---@field AnathemasChains number
---@field AntitowerSocks number
---@field ArchangelsStaff number
---@field ArdentCenser number
---@field AxiomArc number
---@field BFSword number
---@field BamisCinder number
---@field BandleglassMirror number
---@field BansheesVeil number
---@field BerserkersGreaves number
---@field BlackCleaver number
---@field BlackMistScythe number
---@field BladeOfTheRuinedKing number
---@field BlastingWand number
---@field BlightingJewel number
---@field Bloodthirster number
---@field Bloodward number
---@field Boots number
---@field BootsOfSwiftness number
---@field BrambleVest number
---@field BrokenStopwatch number
---@field BulwarkOfTheMountain number
---@field Caesura number
---@field CaulfieldsWarhammer number
---@field CeaselessHunger number
---@field ChainVest number
---@field ChempunkChainsword number
---@field ChemtechPutrifier number
---@field CloakOfAgility number
---@field ClothArmor number
---@field CommencingStopwatch number
---@field ControlWard number
---@field CorruptingPotion number
---@field CosmicDrive number
---@field CrownOfTheShatteredQueen number
---@field CrystallineBracer number
---@field Cull number
---@field Dagger number
---@field DarkSeal number
---@field DeadMansPlate number
---@field DeathsDance number
---@field Deicide number
---@field DemonicEmbrace number
---@field DivineSunderer number
---@field DoransBlade number
---@field DoransRing number
---@field DoransShield number
---@field DraktharrsShadowcarver number
---@field Dreamshatter number
---@field DuskbladeOfDraktharr number
---@field Eclipse number
---@field EdgeOfNight number
---@field ElixirOfIron number
---@field ElixirOfSorcery number
---@field ElixirOfWrath number
---@field Emberknife number
---@field Equinox number
---@field EssenceReaver number
---@field EternalWinter number
---@field Evenshroud number
---@field Everfrost number
---@field ExecutionersCalling number
---@field EyeOfLuden number
---@field EyeOfTheHerald number
---@field FaerieCharm number
---@field FarsightAlteration number
---@field FiendishCodex number
---@field Fimbulwinter number
---@field ForbiddenIdol number
---@field ForceOfNature number
---@field ForgefireCrest number
---@field Fortification number
---@field Frostfang number
---@field FrostfireGauntlet number
---@field FrozenHeart number
---@field Galeforce number
---@field GangplankPlaceholder number
---@field GargoyleStoneplate number
---@field GiantsBelt number
---@field GlacialBuckler number
---@field Goredrinker number
---@field GuardianAngel number
---@field GuardiansBlade number
---@field GuardiansHammer number
---@field GuardiansHorn number
---@field GuardiansOrb number
---@field GuinsoosRageblade number
---@field Gusto number
---@field Hailblade number
---@field HarrowingCrescent number
---@field HealthPotion number
---@field HearthboundAxe number
---@field Hexdrinker number
---@field HextechAlternator number
---@field HextechRocketbelt number
---@field HorizonFocus number
---@field Hullbreaker number
---@field IcathiasCurse number
---@field ImmortalShieldbow number
---@field ImperialMandate number
---@field InfinityEdge number
---@field InfinityForce number
---@field IonianBootsOfLucidity number
---@field IronspikeWhip number
---@field KalistasBlackSpear number
---@field Kindlegem number
---@field KircheisShard number
---@field KnightsVow number
---@field KrakenSlayer number
---@field LastWhisper number
---@field LeechingLeer number
---@field LiandrysAnguish number
---@field LiandrysLament number
---@field LichBane number
---@field LightningRod number
---@field LocketOfTheIronSolari number
---@field LongSword number
---@field LordDominiksRegards number
---@field LostChapter number
---@field LudensTempest number
---@field Manamune number
---@field MawOfMalmortius number
---@field MejaisSoulstealer number
---@field MercurialScimitar number
---@field MercurysTreads number
---@field MikaelsBlessing number
---@field MinionDematerializer number
---@field MobilityBoots number
---@field MoonstoneRenewer number
---@field Morellonomicon number
---@field MortalReminder number
---@field Muramana number
---@field NashorsTooth number
---@field NavoriQuickblades number
---@field NeedlesslyLargeRod number
---@field NegatronCloak number
---@field NightHarvester number
---@field Noonquiver number
---@field NullMagicMantle number
---@field OblivionOrb number
---@field ObsidianEdge number
---@field OracleLens number
---@field Overcharged number
---@field PauldronsOfWhiterock number
---@field PenetratingBullets number
---@field PerfectlyTimedStopwatch number
---@field Phage number
---@field PhantomDancer number
---@field PhreakishGusto number
---@field Pickaxe number
---@field PlatedSteelcaps number
---@field PoroSnax number
---@field ProwlersClaw number
---@field QuicksilverSash number
---@field RabadonsDeathcap number
---@field Rageknife number
---@field RanduinsOmen number
---@field RapidFirecannon number
---@field RavenousHydra number
---@field RecurveBow number
---@field Redemption number
---@field RefillablePotion number
---@field ReinforcedArmor number
---@field RejuvenationBead number
---@field RelicShield number
---@field ReliquaryOfTheGoldenDawn number
---@field Riftmaker number
---@field RimeforgedGrasp number
---@field RubyCrystal number
---@field RunaansHurricane number
---@field RunesteelSpaulders number
---@field RylaisCrystalScepter number
---@field SandshrikesClaw number
---@field SapphireCrystal number
---@field ScarecrowEffigy number
---@field SeatOfCommand number
---@field SeekersArmguard number
---@field SeraphsEmbrace number
---@field SerpentsFang number
---@field SerratedDirk number
---@field SeryldasGrudge number
---@field Shadowflame number
---@field ShardOfTrueIce number
---@field Sheen number
---@field ShurelyasBattlesong number
---@field ShurelyasRequiem number
---@field SilvermereDawn number
---@field SlightlyMagicalFootwear number
---@field SorcerersShoes number
---@field SpectralSickle number
---@field SpectresCowl number
---@field SpellthiefsEdge number
---@field SpiritVisage number
---@field StaffOfFlowingWater number
---@field Starcaster number
---@field StealthWard number
---@field SteelShoulderguards number
---@field SteraksGage number
---@field StirringWardstone number
---@field Stopwatch number
---@field Stormrazor number
---@field Stridebreaker number
---@field StructureBounty number
---@field SunfireAegis number
---@field SuperMechArmor number
---@field SuperMechPowerField number
---@field Syzygy number
---@field TargonsBuckler number
---@field TearOfTheGoddess number
---@field TheCollector number
---@field TheGoldenSpatula number
---@field Thornmail number
---@field Tiamat number
---@field TitanicHydra number
---@field TotalBiscuitofEverlastingWill number
---@field TrinityForce number
---@field TurboChemtank number
---@field TurbochargedHexperiment number
---@field TurretPlating number
---@field Typhoon number
---@field UmbralGlaive number
---@field UpgradedAeropack number
---@field VampiricScepter number
---@field Vanguard number
---@field VerdantBarrier number
---@field Vespertide number
---@field VigilantWardstone number
---@field VoidStaff number
---@field WardensEye number
---@field WardensMail number
---@field WarmogsArmor number
---@field WatchfulWardstone number
---@field WingedMoonplate number
---@field WintersApproach number
---@field WitsEnd number
---@field WyrmfallenSacrifice number
---@field YoumuusGhostblade number
---@field YourCut number
---@field Zeal number
---@field ZekesConvergence number
---@field ZhonyasHourglass number
local ItemIds
_G.CoreEx.Enums.ItemIds = ItemIds
