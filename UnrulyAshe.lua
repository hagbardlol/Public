...
module("UnrulyAshe", package.seeall, log.setup)
clean.module("UnrulyAshe", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/UnrulyAshe.lua", "1.0.4")
