...
module("UnrulyUdyr", package.seeall, log.setup)
clean.module("UnrulyUdyr", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/UnrulyUdyr.lua", "1.0.6")
