...
module("Unruly Leona", package.seeall, log.setup)
clean.module("Unruly Leona", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/UnrulyLeona.lua", "1.0.7")
