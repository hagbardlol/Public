...
module("Coozbie Sivir", package.seeall, log.setup)
clean.module("Coozbie Sivir", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/CXSivir.lua", "1.6")
