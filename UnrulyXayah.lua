...
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/UnrulyXayah.lua", "1.0.5")
...
local Text = {
    ...
    Subtitle = " No need to panic! We have made a new assembly available for you.",
    Message = " Just check the forum or download the new assembly with the in-game downloader.",
}

local Size = {
    Border = Vector(600, 250), -- width, height
    Background = Vector(599, 248),
    Logo = Vector(350, 100),
...
local function DrawBackground()
    Renderer.DrawRectOutline(Position.Border, Size.Border, 1, 2, 0x0D1B18FF)
    Renderer.DrawFilledRect(Position.Background, Size.Background, 1, 0x1A332FFF)
end
