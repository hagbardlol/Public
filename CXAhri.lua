...
module("Coozbie Ahri", package.seeall, log.setup)
clean.module("Coozbie Ahri", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/CXAhri.lua", "2.9")
